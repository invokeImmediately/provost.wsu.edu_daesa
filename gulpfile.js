...
function getCssBuildSettings() {
	...
	var insertingMediaQuerySectionHeader = {
		...
		'lineBefore': '/*! ======================================================================' +
			...
			'ately/oue.wsu.edu/\r\n***\r\n*** AUTHOR: Daniel Rieck [daniel.rieck@wsu.edu] (https:' +
			'//github.com/invokeImmediately)\r\n***\r\n*** LICENSE: ISC - Copyright (c) 2020 Dani' +
			...
			'ies.\r\n***\r\n***   THE SOFTWARE IS PROVIDED "AS IS" AND DANIEL C. RIECK DISCLAIMS ' +
			'ALL WARRANTIES WITH REGARD TO\r\n***   THIS SOFTWARE INCLUDING ALL IMPLIED WARRANTIE' +
			'S OF MERCHANTABILITY AND FITNESS. IN NO EVENT\r\n***   SHALL DANIEL C. RIECK BE LIAB' +
			'LE FOR ANY SPECIAL, DIRECT, INDIRECT, OR CONSEQUENTIAL DAMAGES OR\r\n***   ANY DAMAG' +
